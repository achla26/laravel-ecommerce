        ...
        <tbody>
            ...
            <tr>
              ...
              <td>
               ...
               <td>
                 @if($item->is_home ==1)
                 <a href="{{url('admin/Category/home/0/'.$item->id)}}" class="btn bg-maroon btn-flat margin btn-sm">Show</a>
                 @else
                 <a href="{{url('admin/Category/home/1/'.$item->id)}}" class="btn bg-orange btn-flat margin btn-sm">Hide</a>
                 @endif
