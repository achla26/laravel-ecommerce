...
// });
    ...
    Route::get('admin/Category/home/{status}/{id}',[CategoryController::class,'home']);
    
    Route::get('admin/Banner',[BannerController::class,'index']);
    Route::get('admin/Banner/Manage',[BannerController::class,'manage_banner']);
    ...
    Route::get('admin/Banner/Manage/{id}',[BannerController::class,'manage_banner']);
    Route::get('admin/Banner/{status}/{id}',[BannerController::class,'status']);
    ...
    Route::get('admin/Brand/home/{status}/{id}',[BrandController::class,'home']);
